...
ActiveRecord::Schema.define(version: 20160531015547) do

  create_table "payments", force: :cascade do |t|
    t.string   "app",        limit: 60
    t.integer  "cbi",                   precision: 38, default: 0
    t.integer  "ct",                    precision: 38, default: 0
    t.integer  "fee",                   precision: 38, default: 0
    t.integer  "pt",                    precision: 38, default: 0
    t.string   "sdk",        limit: 60
    t.string   "ssid",       limit: 60
    t.integer  "st",                    precision: 38, default: 0
  ...
  add_index "users", ["user_name"], name: "index_users_on_name", unique: true
