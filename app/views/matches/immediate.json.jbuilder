...
json.matches @matches do |m|
  ...
  json.is_home_bigdata_recommend? match.is_home_bigdata_recommend?
  json.is_home_yinglang_recommend? match.is_home_yinglang_recommend?
  json.is_guest_bigdata_recommend? match.is_guest_bigdata_recommend?
  json.is_guest_yinglang_recommed? match.is_guest_yinglang_recommend?
end
