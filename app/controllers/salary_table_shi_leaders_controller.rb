#coding: utf-8
#市局领导-工资表
class SalaryTableShiLeadersController < SalaryTablesController
  defaults :resource_class => SalaryTableShiLeader, :collection_name => 'salary_table_shi_leaders', :instance_name => 'salary_table_shi_leader'
