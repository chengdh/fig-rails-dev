...
class TaskCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create task_category" do
    assert_difference('TaskCategory.count') do
      post :create, task_category: { is_active: @task_category.is_active, name: @task_category.name, note: @task_category.note, order_by: @task_category.order_by }
    end
  ...
  test "should update task_category" do
    patch :update, id: @task_category, task_category: { is_active: @task_category.is_active, name: @task_category.name, note: @task_category.note, order_by: @task_category.order_by }
    assert_redirected_to task_category_path(assigns(:task_category))
  end
