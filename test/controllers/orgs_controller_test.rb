...
class OrgsControllerTest < ActionController::TestCase
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post :create, org: { : @org., address: @org.address, is_active: @org.is_active, name: @org.name, note: @org.note, order_by: @org.order_by, org_type: @org.org_type }
    end
  ...
  test "should update org" do
    patch :update, id: @org, org: { : @org., address: @org.address, is_active: @org.is_active, name: @org.name, note: @org.note, order_by: @org.order_by, org_type: @org.org_type }
    assert_redirected_to org_path(assigns(:org))
  end
